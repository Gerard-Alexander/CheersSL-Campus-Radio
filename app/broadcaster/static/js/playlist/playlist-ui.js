...
let nowPlayingDeleteHandler = null;
export function setNowPlayingDeleteHandler(handler) {
    nowPlayingDeleteHandler = handler;
}

export function setUpPlaylist(onReorder) {
...
export function updateNowPlaying(item) {
    ...
    nowPlayingContent.appendChild(
        createMediaBlock(item, 0, undefined, () => {
            nowPlayingDeleteHandler?.();
        })
    );
